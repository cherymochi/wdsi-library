...
<nav>
    ...
    <div class="container3">
        ...
        <form action="../includes/HSadminvalidation.php" autocomplete="off" method="post">

            <div class="form-content">
                <label for="libID">Admin ID</label><br>
                <input class="text-in" type="text" id="AdminID" name="AdminID" placeholder="0000000">
                ...
                <input class="text-in" type="password" required>
                <br><br>
            ...
            <br>
            <center>
                <button type="submit" name="submitted" class="button">SIGNIN</button>
                <br><br>
            </center>
        </form>
    </div>
